...
| 5 | Geração da Tabela de Estoque (consolidação do inventário declarado, Bloco H) | ✅ Implementado (estoque_anual_consolidado — foco só em consolidação; **é aqui que o "estoque" passa a existir de fato**; regra de continuidade corrigida em 2026-07-17, desvio de 1 ano; Auditoria de Divergência de Estoque vs. Excel de referência já implementada, ver AUDITORIA1 no Estágio 6; cálculo de divergência/RN1 propriamente dito — cruzando contra a movimentação do Estágio 4 — fica pra uma etapa futura, Estágio 15) | [docs/estagios/05_tabela_estoque.md](docs/estagios/05_tabela_estoque.md) |
...
- Numeração não é estritamente sequencial (ver o salto 6 → 15): o Estágio 6
  ...
  "Tabelas Entradas / Saídas / Estoques" (nome desde 2026-07-14, antes
