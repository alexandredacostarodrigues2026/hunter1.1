...
docs/estagios/06_menu_navegacao.md) e os 10 grupos de painéis navegáveis
...
Produto, RN1 — Movimentação Física, RN1 por Produto). Arquivo idêntico
...
def main() -> None:
    ...
    if "pagina_ativa" not in st.session_state:
        ...
        # "rn1_produto" = os 10 grupos de painéis navegáveis, ver
